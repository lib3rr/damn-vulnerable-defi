...
contract TheRewarderChallenge is Test {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        ...
        IERC20(address(dvt)).transfer(recovery, IERC20(address(dvt)).balanceOf(player));
        IERC20(address(weth)).transfer(recovery, IERC20(address(weth)).balanceOf(player));
    }
