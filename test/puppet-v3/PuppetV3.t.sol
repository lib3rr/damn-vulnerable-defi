...
contract PuppetV3Challenge is Test {
    ...
    function test_puppetV3() public checkSolvedByPlayer {
        ...
        AttackerPuppetV3 attacker = new AttackerPuppetV3{value: PLAYER_INITIAL_ETH_BALANCE}(lendingPool, uniswapRouter, recovery, token, weth);
...
contract AttackerPuppetV3 {
    ...
    constructor(PuppetV3Pool _lendingPool, ISwapRouter _uniswapRouter, address _recovery, DamnValuableToken _token, WETH _weth) payable {
