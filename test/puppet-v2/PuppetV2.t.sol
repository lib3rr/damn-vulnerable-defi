...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        AttackerPuppetV2 attacker = new AttackerPuppetV2{value: PLAYER_INITIAL_ETH_BALANCE}(lendingPool, uniswapV2Router, recovery, token, weth);
...
contract AttackerPuppetV2 {
    ...
    constructor(PuppetV2Pool _lendingPool, IUniswapV2Router02 _uniswapV2Router, address _recovery, DamnValuableToken _token, WETH _weth) payable {
    ...
    function attack() public {
        ...
        // swap DVT for WETH to tank the price
